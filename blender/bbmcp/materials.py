...
# Fog instance attributes the volumetrics recipe stores, read as INSTANCER floats.
_FOG_KNOBS = ("fog_density", "fog_top", "fog_falloff", "fog_noise", "fog_scale",
              "fog_detail", "fog_seed", "fog_softness", "fog_warp", "fog_aniso")
# Extra attributes only the ground-fog (terrain-draped) material reads.
_FOG_GROUND_KNOBS = ("fog_terrain_size", "fog_terrain_height", "fog_sea_level",
                     "fog_ground_thickness")
