...
| `grow_foliage` | `foliage_build.grow_foliage_op` | `species`: str = `''`<br>`name`: str \| None = `None`<br>`location`: tuple \| None = `None`<br>`collection`: str \| None = `None`<br>`seed`: int \| None = `None`<br>`params`: dict = `{}` |
| `scatter_layer` | `scatter_build.scatter_layer_op` | `emitter`: str = **required**<br>`kind`: 'trees' \| 'rocks' \| 'plants' \| 'grass' \| 'empty' = `'trees'`<br>`knobs`: dict = `{}`<br>`align`: 'up' \| 'normal' \| None = `None`<br>`camera`: str \| None = `None`<br>`curve`: str \| None = `None`<br>`curve_mode`: 'clear' \| 'keep' \| 'verge' \| 'along' \| None = `None`<br>`curve_align`: bool \| None = `None`<br>`assets_exclude`: list \| None = `None`<br>`name`: str \| None = `None`<br>`reuse`: bool = `True`<br>`convert`: bool = `True` |
...
| `make_blockout` | `proxies.make_blockout` | `shape`: str = `'shed'`<br>`name`: str \| None = `None`<br>`params`: dict \| None = `None`<br>`location`: list \| None = `None`<br>`replace`: bool = `False` |
| `paint_stylised` | `gen_paint.paint_stylised_op` | `object`: str = **required**<br>`prompt`: str = **required**<br>`seed`: int = `0`<br>`views`: int = `6`<br>`size`: int = `1024`<br>`denoise`: float \| None = `None`<br>`lora`: str \| None = `None`<br>`lora_strength`: float = `0.8`<br>`pack_dir`: str \| None = `None` |
