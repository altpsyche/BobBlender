...
One-line description: the idea, the math, the mood.

## Layout

| Folder | Contents |
|--------|----------|
| `src/` | Working `.blend` files. Main file: `forest-path_v001.blend`. |
...
- Idea:
- Techniques (geometry nodes, shaders, sim):
- Reusable bits to move into `library/`:
